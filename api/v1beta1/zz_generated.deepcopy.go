...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReporterIdentity) DeepCopyInto(out *ReporterIdentity) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReporterIdentity.
func (in *ReporterIdentity) DeepCopy() *ReporterIdentity {
	if in == nil {
		return nil
	}
	out := new(ReporterIdentity)
...
func (in *WorkloadPlacementSpec) DeepCopyInto(out *WorkloadPlacementSpec) {
	*out = *in
	in.LastPlacedAt.DeepCopyInto(&out.LastPlacedAt)
}
