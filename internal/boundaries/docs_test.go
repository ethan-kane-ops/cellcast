...
func TestTheDocsOnlyNameFlagsThatExist(t *testing.T) {
	...
	pages := []string{"getting-started.md", "pipeline-integration.md", "placement-policy.md", "troubleshooting.md", "index.md"}
...
func TestTheDocsOnlyNameRecipesThatExist(t *testing.T) {
	...
	for _, file := range []string{"docs/development.md", "docs/getting-started.md", "docs/releasing.md", "CONTRIBUTING.md", "README.md"} {
